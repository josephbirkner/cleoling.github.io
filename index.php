<html>
			...
			function redrawChartAndTable() {
				$.get('getChartData.php?ulangs='+ulangs, function(data, status){
					if(status == "success"){
						...
						drawCircularChart(document.getElementById('c'), 4, 30, [350, 350], 300, array);
					}
				});
	...
	<body style="width:window.innerWidth;">
		<div id="header">
			...
			<h4 align='center'><span>Who's linking to whom, </span><span style='color:#DDD'>about what, </span><span>where, in which language?</span></h4>
			<div id="navWrap">
				<div id="nav">
					<ul class="site-menu">
